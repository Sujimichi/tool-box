...
[core]
as_active_plugins = extrawm;video;text;thumbnail;place;fadedesktop;core;shift;move;vpswitch;maximumize;svg;imgjpeg;dbus;resize;workarounds;png;session;decoration;regex;wall;animation;snap;scale;scalefilter;expo;ezoom;scaleaddon;switcher;
as_texture_filter = 1
...
s0_speed = 7.383900
s0_shift_speed = 3.094400
s0_timestep = 1.134200
...
s0_mode = 0
s0_size = 66
s0_background_intensity = 0.202000
s0_hide_all = false
s0_reflection = false
...
as_initiate_all_key = <Shift><Alt><Super>Up
