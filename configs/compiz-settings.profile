...
as_trigger_key = <Shift><Alt>Right
...
as_initiate_all_button = <Shift><Control><Alt>Button1
...
as_clear_key = <Alt><Super>c
as_clear_button = Disabled
s0_num_particles = 5967
s0_fire_size = 16.297001
s0_fire_slowdown = 0.500000
s0_fire_life = 0.700000
s0_fire_color = #ff3305ff
s0_fire_mystical = false
...
s0_speed = 4.200000
s0_shift_speed = 2.084100
s0_timestep = 32.704800
...
s0_mode = 0
s0_size = 50
s0_background_intensity = 0.540800
s0_hide_all = false
s0_reflection = true
s0_ground_color1 = #b3b3b3cc
s0_ground_color2 = #b3b3b300
...
[core]
as_active_plugins = resize;maximumize;dbus;place;water;png;svg;regex;move;vpswitch;fadedesktop;workarounds;session;text;video;imgjpeg;core;extrawm;decoration;shift;thumbnail;snap;wall;scale;animation;expo;ezoom;scaleaddon;switcher;scalefilter;
as_texture_filter = 1
...
as_maximize_window_horizontally_key = <Alt>s
as_maximize_window_vertically_key = <Alt>w
...
as_toggle_window_maximized_key = <Alt>a
...
as_toggle_window_shaded_key = <Alt>e
as_ignore_hints_when_maximized = true
as_command_terminal = gnome-terminal
as_run_command_terminal_key = <Alt>q
as_cursor_theme = whiteglass
as_cursor_size = 24
as_ping_delay = 5000
...
as_toggle_sticky_key = <Control>g
