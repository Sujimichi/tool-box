...
[core]
as_active_plugins = extrawm;video;text;thumbnail;place;core;shift;move;vpswitch;svg;imgjpeg;dbus;resize;workarounds;png;session;decoration;regex;wall;animation;scale;scalefilter;expo;ezoom;scaleaddon;switcher;
as_texture_filter = 1
...
as_initiate_all_edge = 
as_initiate_all_button = Disabled
as_initiate_all_key = <Control><Alt><Super>Up
